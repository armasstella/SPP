...
public class IncludeMonthlyActivityModificationListener implements DoubleClickListener<ActivityDTO> {

    private final MonthlyReportGenerationController controller;

    public IncludeMonthlyActivityModificationListener(MonthlyReportGenerationController controller) {
