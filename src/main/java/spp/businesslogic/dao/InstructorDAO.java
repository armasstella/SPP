...
public class InstructorDAO implements IInstructorDAO {
    ...
    public boolean deactivateInstructor(InstructorDTO instructorDTO) throws DAOException {
        ...
        try {
            ...
            AppLogger.logError(ExceptionLevel.FATAL, e);
            throw new DAOException("Error de concurrencia al desactivar profesor.");

        } catch (SQLInvalidAuthorizationSpecException e) {
            AppLogger.logError(ExceptionLevel.FATAL, e);
            throw new DAOException("Error de comunicación con el servidor al desactivar profesor.");

        } catch (SQLTimeoutException e) {
            AppLogger.logError(ExceptionLevel.FATAL, e);
            throw new DAOException("Tiempo de espera agotado al desactivar profesor.");
